...
@testset "Background" begin
    ...
    @test isapprox(Effort._E_z(0., Ωcb0, h), Effort._E_a(1., Ωcb0, h))
...
@testset "Effort tests" begin
    ...
    a,b,c = Effort.apply_AP(myx, monotest, quadtest, hexatest, q_par, q_perp; n_GL_points = 16)
    ...
    a,b,c = Effort.apply_AP(k, Pℓ[1,:], Pℓ[2,:], Pℓ[3,:], qpar, qperp; n_GL_points=5)

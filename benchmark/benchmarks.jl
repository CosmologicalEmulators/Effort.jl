...
SUITE["jacobian"]["apply_AP_batch"] = @benchmarkable begin
    ...
    k_input = $k_grid_jac;
    k_output = $k_grid_jac;
    P0, Jac0 = Effort.get_Pℓ_jacobian($cosmology_jac_test, $D_jac_test, $bias_jac_test, $emulator_0);
    P2, Jac2 = Effort.get_Pℓ_jacobian($cosmology_jac_test, $D_jac_test, $bias_jac_test, $emulator_2);
    P4, Jac4 = Effort.get_Pℓ_jacobian($cosmology_jac_test, $D_jac_test, $bias_jac_test, $emulator_4);
    q_par = $qpar_jac;
    q_perp = $qperp_jac
)

...
@kwdef mutable struct ComponentEmulator <: AbstractComponentEmulators
...
function compute_component(input_params, comp_emu::ComponentEmulator)
...
@kwdef mutable struct PℓEmulator <: AbstractPℓEmulators
    P11::AbstractComponentEmulators
    Ploop::AbstractComponentEmulators
    Pct::AbstractComponentEmulators
end
